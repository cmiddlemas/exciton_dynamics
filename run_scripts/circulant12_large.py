...
sys.path.append('/home/tm17/source_code/exciton_dynamics/src')
...
if __name__ == '__main__':
    data_path = '/scratch/gpfs/tm17/graphdyn/circulant12_large/'
    base_name = 'circulant12_large'
    ...
    graph = nx.circulant_graph(N, [1,2])
    nx.draw(graph)
